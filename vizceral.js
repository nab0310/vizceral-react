...
/***/ function(module, exports, __webpack_require__) {
	...
	var _vizceral = __webpack_require__(4);
	
	var _vizceral2 = _interopRequireDefault(_vizceral);
	...
	var Vizceral = function (_React$Component) {
	  _inherits(Vizceral, _React$Component);
	
	  function Vizceral() {
	    _classCallCheck(this, Vizceral);
	
	    return _possibleConstructorReturn(this, (Vizceral.__proto__ || Object.getPrototypeOf(Vizceral)).apply(this, arguments));
	  }
	  ...
	  _createClass(Vizceral, [{
	    ...
	    value: function componentDidMount() {
	      ...
	      this.vizceral = new _vizceral2.default(this.refs.vizCanvas, this.props.targetFramerate);
	      ...
	      if (!(0, _lodash.isEqual)(this.props.filters, Vizceral.defaultProps.filters)) {
	        this.vizceral.setFilters(this.props.filters);
	      }
	
	      if (!(0, _lodash.isEqual)(this.props.definitions, Vizceral.defaultProps.definitions)) {
	      ...
	      // animate properly.
	      setTimeout(function () {
	        _this2.vizceral.setView(_this2.props.view || Vizceral.defaultProps.view, _this2.props.objectToHighlight);
	        _this2.vizceral.updateData(_this2.props.traffic);
	        var perfNow = getPerformanceNow();
	        _this2.vizceral.animate(perfNow === null ? 0 : perfNow);
	        _this2.vizceral.updateBoundingRectCache();
	      }, 0);
	    }
	  }, {
	    key: 'componentWillReceiveProps',
	    value: function componentWillReceiveProps(nextProps) {
	      if (!(0, _lodash.isEqual)(nextProps.styles, this.props.styles)) {
	        this.updateStyles(nextProps.styles);
	      }
	      if (!(0, _lodash.isEqual)(nextProps.view, this.props.view) || !(0, _lodash.isEqual)(nextProps.objectToHighlight, this.props.objectToHighlight)) {
	        this.vizceral.setView(nextProps.view, nextProps.objectToHighlight);
	      }
	
	      if (!(0, _lodash.isEqual)(nextProps.filters, this.props.filters)) {
	        this.vizceral.setFilters(nextProps.filters);
	      }
	      if (!(0, _lodash.isEqual)(nextProps.showLabels, this.props.showLabels) || !(0, _lodash.isEqual)(nextProps.allowDraggingOfNodes, this.props.allowDraggingOfNodes)) {
	        this.vizceral.setOptions({
	          allowDraggingOfNodes: nextProps.allowDraggingOfNodes,
	          showLabels: nextProps.showLabels
	        });
	      }
	      if (!(0, _lodash.isEqual)(nextProps.modes, this.props.modes)) {
	        this.vizceral.setModes(nextProps.modes);
	      }
	
	      if (!(0, _lodash.isEqual)(nextProps.definitions, this.props.definitions)) {
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        'div',
	        { className: 'vizceral' },
	        _react2.default.createElement('canvas', { style: { width: '100%', height: '100%' }, ref: 'vizCanvas' }),
	        _react2.default.createElement('div', { className: 'vizceral-notice' })
	      );
	    }
	    ...
	    value: function updateStyles(styles) {
	      var styleNames = this.vizceral.getStyles();
	...
	Vizceral.propTypes = {
	   ...
	   */
	  connectionHighlighted: _react2.default.PropTypes.func,
	  /**
	   ...
	   */
	  definitions: _react2.default.PropTypes.object,
	  /**
	   ...
	   */
	  modes: _react2.default.PropTypes.object,
	  /**
	   ...
	   */
	  allowDraggingOfNodes: _react2.default.PropTypes.bool,
	  /**
	   ...
	   */
	  traffic: _react2.default.PropTypes.object,
	  /**
	   * Callback for when the view changed. The view array is the only property.
	   */
	  viewChanged: _react2.default.PropTypes.func,
	  /**
	   * Callback for when the current view is updated.
	   */
	  viewUpdated: _react2.default.PropTypes.func,
	  /**
	  * Target framerate for rendering engine
	  */
	  targetFramerate: _react2.default.PropTypes.number
	};
	
	Vizceral.defaultProps = {
	  connectionHighlighted: function connectionHighlighted() {},
	  definitions: {},
	  filters: [],
	  match: '',
	  nodeHighlighted: function nodeHighlighted() {},
	  nodeUpdated: function nodeUpdated() {},
	  nodeContextSizeChanged: function nodeContextSizeChanged() {},
	  matchesFound: function matchesFound() {},
	  objectHighlighted: function objectHighlighted() {},
	  showLabels: true,
	  allowDraggingOfNodes: false,
	  styles: {},
	  traffic: {},
	  viewChanged: function viewChanged() {},
	  viewUpdated: function viewUpdated() {},
	  view: [],
...
;
//# sourceMappingURL=vizceral.js.map